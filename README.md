...
- [ampproject/amphtml](https://github.com/ampproject/amphtml/labels/good%20first%20issue)_(label: good first issue)_ <br> The AMP web component framework
...
- [STVIR/pysot](https://github.com/STVIR/pysot/labels/good-first-issue)_(label: good-first-issue)_ <br>SenseTime Research Platform for single object tracking,implementing algorithms like SiamRPN and SiamMask.
